...
public class BlockGame extends JPanel implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener{
    ...
    public BlockGame() {
		...
		if (playerCount == 1) {
			JOptionPane.showOptionDialog(null, this.p1goal.description() , "Player 1 - assignment3.Goal", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new String[]{"OK"}, "OK");
			...
			JOptionPane.showOptionDialog(null, this.p1goal.description() , "Player 1 - assignment3.Goal", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new String[]{"OK"}, "OK");
			JOptionPane.showOptionDialog(null, this.p2goal.description() , "Player 2 - assignment3.Goal", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new String[]{"OK"}, "OK");
			p1ScoreLabel.setForeground(GameColors.BLOCK_COLORS[p1TargetColor]);
