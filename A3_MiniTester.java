...
class Part3Test {  // ======== 16 points ========
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.PerimeterGoal score() test1")
    void PGscore1() {
        Block[] children = new Block[4];
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.PerimeterGoal score() test2")
    void PGscore2() {
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.BlobGoal undiscoveredBlobSize() test1")
    void BGBlobSize1() {
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.BlobGoal undiscoveredBlobSize() test2")
    void BGBlobSize2() {
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.BlobGoal undiscoveredBlobSize() test3")
    void BGBlobSize3() {
        Block.gen = new Random(8);
        Block b = new Block(0, 2);
        b.updateSizeAndPosition(16, 0, 0);
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.BlobGoal score() test1")
    void BGscore1() {
        Block[] children = new Block[4];
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.BlobGoal score() test2")
    void BGscore2() {
